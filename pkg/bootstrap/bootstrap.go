...
//
// 返回：
//   - vivid.PrimaryActorSystem：PrimaryActorSystem 实例
//
// 说明：
...
func NewActorSystem(options ...vivid.ActorSystemOption) vivid.PrimaryActorSystem {
	return actor.NewSystem(options...)
}

...
//
// 返回：
//   - *sugar.Result[vivid.PrimaryActorSystem]：包含 PrimaryActorSystem 实例和错误信息的泛型结果
//
// 说明：
...
func NewActorSystem(options ...vivid.ActorSystemOption) *sugar.Result[vivid.PrimaryActorSystem] {
	return sugar.Cast[*actor.System, vivid.PrimaryActorSystem](actor.NewSystem(options...))
}

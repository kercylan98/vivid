...
func newMailboxCentral(remotingServerRef vivid.ActorRef, actorLiaison vivid.ActorLiaison) *MailboxCentral {
...
func (rmc *MailboxCentral) GetOrCreate(advertiseAddr string, envelopHandler NetworkEnvelopHandler) *Mailbox {
	...
	if !ok {
		m = newMailbox(advertiseAddr, envelopHandler, rmc.actorLiaison, rmc.remotingServerRef)

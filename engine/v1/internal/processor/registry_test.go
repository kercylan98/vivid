...
// Handle 实现 Unit 接口
func (t *TestUnit) Handle(sender processor.UnitIdentifier, message any) {
    t.handle = true
}
...
func (t *TestRegistryConfigurator) Configure(c *processor.RegistryConfiguration) {
    c.WithUnitIdentifier(processor.NewUnitIdentifier("localhost", "/")).WithLogger(log.GetDefault())
}
...
func TestNewRegistry(t *testing.T) {
    ...
    processor.NewRegistryWithConfigurators(processor.RegistryConfiguratorFN(func(c *processor.RegistryConfiguration) {
        c.WithLogger(log.GetDefault()).
            WithUnitIdentifier(processor.NewUnitIdentifier("localhost", "/"))
